    ...
    <div className="app app-shell">
      <header className="main-site-header">
        <div className="brand-area">
          <img
            src={`${import.meta.env.BASE_URL}printai-logo.png`}
            alt="Digital Pehlwan PrintAI Logo"
            ...
            style={{
              ...
              background: "#ffffff",
              padding: "6px",
              boxShadow: "0 10px 28px rgba(0, 64, 128, 0.14)"
            }}
          />
          <div>
            <h1>Digital Pehlwan PrintAI</h1>
            <p>Smart tools for print-ready design workflows</p>
          </div>
        </div>

        <nav className="top-public-menu">
          <a href="#home">Home</a>
      ...
      <div className="dashboard-layout">
        <main className="dashboard-content" id="home">
          <section className="landing-hero-box">
            <div>
              <span className="hero-mini-badge">India's Smart PrintAI SaaS</span>
              <h2>Smart print-ready tools for designers, print shops and agencies.</h2>
              <p>Upload, analyze, repair, edit, resize, export and prepare images for professional printing from one dashboard.</p>
            </div>
            <div className="hero-action-box">
              <a href="#demo" className="hero-primary-link">Book Demo</a>
              <a href="#pricing" className="hero-secondary-link">View Pricing</a>
            </div>
          </section>
          ...
          {!["importexport", "print", "batch", "admin"].includes(tab) && (
        <>
      ...
      {!["importexport", "print", "batch", "admin"].includes(tab) && !image && (
      ...
      {tab === "batch" && <SmartBatchStudio />}
          ...
          <section className="website-info-grid">
            <div className="website-info-card" id="about">
              <span>About Us</span>
              <h3>Digital Pehlwan PrintAI</h3>
              <p>One dashboard for smart print workflows: analysis, repair, editing, print setup, batch processing and export-ready tools.</p>
            </div>

            <div className="website-info-card" id="pricing">
              <span>Pricing</span>
              <h3>Free • Pro • Studio</h3>
              <p>Start with demo access. Paid plans can be added for print shops, designers, agencies and high-volume studios.</p>
            </div>

            <div className="website-info-card" id="demo">
              <span>Book Demo</span>
              <h3>Want a live walkthrough?</h3>
              <p>Book a demo slot to see Smart Studio, Smart Editing, Smart Repair, Smart Print Studio and Smart Batch Studio in action.</p>
            </div>

            <div className="website-info-card" id="contact">
              <span>Contact Us</span>
              <h3>Digital Pehlwan</h3>
              <p>For SaaS setup, demo booking, pricing or custom print workflow automation, email us at pehlwandigital@gmail.com.</p>
            </div>
          </section>
        ...
        <aside className="module-sidebar">
          <div className="module-sidebar-card">
            <p className="module-sidebar-title">PrintAI Modules</p>

            <button
              className={tab === "importexport" ? "side-module-btn active-side-module" : "side-module-btn"}
            ...
            <button
              className={tab === "analysis" ? "side-module-btn active-side-module" : "side-module-btn"}
            ...
            <button
              className={tab === "repair" ? "side-module-btn active-side-module" : "side-module-btn"}
            ...
            <button
              className={tab === "edit" ? "side-module-btn active-side-module" : "side-module-btn"}
              onClick={() => setTab("edit")}
            >
              Smart Editing
            </button>
            ...
            <button
              className={tab === "print" ? "side-module-btn active-side-module" : "side-module-btn"}
            ...
            <button
              className={tab === "batch" ? "side-module-btn active-side-module" : "side-module-btn"}
              onClick={() => setTab("batch")}
            >
              Smart Batch Studio
            </button>

            <div className="coming-soon-divider">Coming Soon</div>

            <button type="button" className="side-module-btn coming-soon-btn" disabled>
              Smart Wording Studio
            </button>
